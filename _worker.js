...
let proxyIP = 'www.globe.com.ph';// 小白勿动，该地址并不影响你的网速，这是给CF代理使用的。'cdn.xn--b6gac.eu.org, cdn-all.xn--b6gac.eu.org, workers.cloudflare.cyou'
...
let proxyIPs= ['cdn.xn--b6gac.eu.org', 'www.globe.com.ph', 'workers.cloudflare.cyou'];
let addresses = [];
let addressesapi = [];
let addressesnotls = [];
